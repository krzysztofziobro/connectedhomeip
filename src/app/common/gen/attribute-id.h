...
// Attribute ids for cluster: TimeSync

// Client attributes

// Server attributes
#define ZCL_TIME_SYNC_UTC_TIME_ATTRIBUTE_ID (0x0001)
#define ZCL_TIME_SYNC_GRANULARITY_ATTRIBUTE_ID (0x0002)
#define ZCL_TIME_SYNC_TIME_SOURCE_ATTRIBUTE_ID (0x0003)
#define ZCL_TIME_SYNC_TRUSTED_TIME_NODE_ID_ATTRIBUTE_ID (0x0004)
#define ZCL_TIME_SYNC_DEFAULT_NTP_ATTRIBUTE_ID (0x0005)
#define ZCL_TIME_SYNC_TIME_ZONE_ATTRIBUTE_ID (0x0006)
#define ZCL_TIME_SYNC_DST_OFFSET_ATTRIBUTE_ID (0x0007)
#define ZCL_TIME_SYNC_LOCAL_TIME_ATTRIBUTE_ID (0x0008)
#define ZCL_TIME_SYNC_TIME_ZONE_DATABASE_ATTRIBUTE_ID (0x0009)
#define ZCL_TIME_SYNC_NTP_SERVER_PORT_ATTRIBUTE_ID (0x000A)
