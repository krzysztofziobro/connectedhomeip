...
enum EmberAfGranularityEnum : uint8_t
{
    EMBER_ZCL_GRANULARITY_ENUM_NO_TIME_GRANULARITY      = 0,
    EMBER_ZCL_GRANULARITY_ENUM_MINUTES_GRANULARITY      = 1,
    EMBER_ZCL_GRANULARITY_ENUM_SECONDS_GRANULARITY      = 2,
    EMBER_ZCL_GRANULARITY_ENUM_MILLISECONDS_GRANULARITY = 3,
    EMBER_ZCL_GRANULARITY_ENUM_MICROSECONDS_GRANULARITY = 4,
};
...
enum EmberAfTimeSourceEnum : uint8_t
{
    EMBER_ZCL_TIME_SOURCE_ENUM_NONE                = 0,
    EMBER_ZCL_TIME_SOURCE_ENUM_UNKNOWN             = 1,
    EMBER_ZCL_TIME_SOURCE_ENUM_ADMIN               = 2,
    EMBER_ZCL_TIME_SOURCE_ENUM_NODE_TIME_CLUSTER   = 3,
    EMBER_ZCL_TIME_SOURCE_ENUM_NON_FABRIC_SNTP     = 4,
    EMBER_ZCL_TIME_SOURCE_ENUM_NON_FABRIC_NTP      = 5,
    EMBER_ZCL_TIME_SOURCE_ENUM_FABRIC_SNTP         = 6,
    EMBER_ZCL_TIME_SOURCE_ENUM_FABRIC_NTP          = 7,
    EMBER_ZCL_TIME_SOURCE_ENUM_MIXED_NTP           = 8,
    EMBER_ZCL_TIME_SOURCE_ENUM_NON_FABRIC_SNTP_NTS = 9,
    EMBER_ZCL_TIME_SOURCE_ENUM_NON_FABRIC_NTP_NTS  = 10,
    EMBER_ZCL_TIME_SOURCE_ENUM_FABRIC_SNTP_NTS     = 11,
    EMBER_ZCL_TIME_SOURCE_ENUM_FABRIC_NTP_NTS      = 12,
    EMBER_ZCL_TIME_SOURCE_ENUM_MIXED_NTP_NTS       = 13,
    EMBER_ZCL_TIME_SOURCE_ENUM_CLOUD_SOURCE        = 14,
    EMBER_ZCL_TIME_SOURCE_ENUM_PTP                 = 15,
    EMBER_ZCL_TIME_SOURCE_ENUM_GNSS                = 16,
};
