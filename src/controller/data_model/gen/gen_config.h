...
#define EMBER_AF_TIMESYNC_CLUSTER_CLIENT_ENDPOINT_COUNT (1)
...
// Use this macro to check if the client side of the TimeSync cluster is included
#define ZCL_USING_TIMESYNC_CLUSTER_CLIENT
#define EMBER_AF_PLUGIN_TIME_SYNC_CLIENT
